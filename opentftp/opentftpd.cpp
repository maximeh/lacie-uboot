...
const char *usage =
  ...
  "    -i [inifile]    Set the configuration file (Default /etc/opentftp.ini)\n"
  "    -l [logfile]    Output log to a file\n"
  "    -v              Verbose mode (with this option, opentftpd run as daemon)\n";
